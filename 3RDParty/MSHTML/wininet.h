...
#define BOOLAPI INTERNETAPIX(BOOL, __success(return != FALSE))
...
BOOLAPI InternetQueryDataAvailable(
    __in HINTERNET hFile,
    __out_opt __out_data_source(NETWORK) LPDWORD lpdwNumberOfBytesAvailable,
    __in DWORD dwFlags,
    __in_opt DWORD_PTR dwContext
    );
...
BOOLAPI InternetQueryOptionA(
    ...
    __in DWORD dwOption,
    __out_bcount_full_opt(*lpdwBufferLength) __out_data_source(NETWORK) LPVOID lpBuffer,
    __inout LPDWORD lpdwBufferLength
    );
...
#define INTERNET_LAST_OPTION                    INTERNET_OPTION_ENABLE_REDIRECT_CACHE_READ
...
BOOLAPI GopherGetAttributeA(
    ...
    __out_ecount(dwBufferLength) __typefix(LPSTR) LPBYTE lpBuffer,
    __in DWORD dwBufferLength,
...
BOOLAPI GopherGetAttributeW(
    ...
    __out_ecount(dwBufferLength) __typefix(LPWSTR) LPBYTE lpBuffer,
    __in DWORD dwBufferLength,
    __out LPDWORD lpdwCharactersReturned,
    __in_opt GOPHER_ATTRIBUTE_ENUMERATOR lpfnEnumerator,
    __in_opt DWORD_PTR dwContext
...
HttpQueryInfoA(
    ...
    __inout_bcount_full_opt(*lpdwBufferLength) __out_data_source(NETWORK) LPVOID lpBuffer,
    __inout LPDWORD lpdwBufferLength,
...
CommitUrlCacheEntryA(
    ...
    __in_ecount_opt(cchHeaderInfo) LPBYTE lpHeaderInfo,
...
CommitUrlCacheEntryW(
    ...
    __in FILETIME LastModifiedTime,
    __in DWORD CacheEntryType,
    __in_ecount_opt(cchHeaderInfo) LPWSTR lpszHeaderInfo,
    __in DWORD cchHeaderInfo,
...
BOOLAPI GetUrlCacheGroupAttributeA(
    ...
    __out_bcount(*lpcbGroupInfo)    LPINTERNET_CACHE_GROUP_INFOA    lpGroupInfo,
    __inout                         LPDWORD                         lpcbGroupInfo,
    __reserved                      LPVOID                          lpReserved
    );
BOOLAPI GetUrlCacheGroupAttributeW(
    ...
    __reserved                      DWORD                           dwFlags,
    __in                            DWORD                           dwAttributes,
    __out_bcount(*lpcbGroupInfo)    LPINTERNET_CACHE_GROUP_INFOW    lpGroupInfo,
    __inout                         LPDWORD                         lpcbGroupInfo,
    __reserved                      LPVOID                          lpReserved
    );
#ifdef UNICODE
...
InternetGetConnectedStateExA(
    ...
    __out_ecount_opt(cchNameLen) LPSTR lpszConnectionName,
    __in DWORD cchNameLen,
    __reserved DWORD dwReserved
);
...
InternetGetConnectedStateExW(
    __out_opt LPDWORD lpdwFlags,
    __out_ecount_opt(cchNameLen) LPWSTR lpszConnectionName,
    __in DWORD cchNameLen,
    __reserved DWORD dwReserved
);
...
BOOLAPI DetectAutoProxyUrl(
    __out_ecount(cchAutoProxyUrl) PSTR pszAutoProxyUrl,
    __in DWORD cchAutoProxyUrl,
...
BOOLAPI InternetEnumPerSiteCookieDecisionA(
    __out_ecount_full(*pcSiteNameSize) LPSTR pszSiteName,
...
BOOLAPI InternetEnumPerSiteCookieDecisionW(
    __out_ecount_full(*pcSiteNameSize) LPWSTR pszSiteName,
    __inout unsigned long *pcSiteNameSize,
    __out unsigned long *pdwDecision,
    __in unsigned long dwIndex
);
