...
#define DISPID_A_MS_BOXALIGN                    (DISPID_A_FIRST+274)
#define DISPID_A_MS_BOXDIRECTION                (DISPID_A_FIRST+275)
#define DISPID_A_MS_BOXFLEX                     (DISPID_A_FIRST+276)
#define DISPID_A_MS_BOXORIENT                   (DISPID_A_FIRST+277)
...
#define DISPID_A_MS_BOXFLEXGROUP                (DISPID_A_FIRST+320)
#define DISPID_A_MS_BOXLINEPROGRESSION          (DISPID_A_FIRST+321)
#define DISPID_A_MS_BOXLINES                    (DISPID_A_FIRST+322)
#define DISPID_A_MS_BOXORDINALGROUP             (DISPID_A_FIRST+323)
#define DISPID_A_MS_BOXPACK                     (DISPID_A_FIRST+324)
...
// #define DISPID_A_MS_FLOWNAME                    (DISPID_A_FIRST+329) // reserved for connected frames
...
#define DISPID_INTERNAL_FIRST                   (DISPID_A_FIRST+400)
...
#define DISPID_INTERNAL_NAMEDFLOWCOLLECTION     (DISPID_INTERNAL_FIRST+35)
...
#define DISPID_EVPROPS_COUNT                (                154)  // (DISPID_EVENTS + 127) NOT USED
...
#define DISPID_IHTMLPRIVATEWINDOW4_GETDNSPRECACHEDATA             
...
//    DISPIDs for interface IHTML5AttributeSelectorCI
